...
//     Camera camera;
//     CameraIOInputsAutoLogged cameraInputs = new CameraIOInputsAutoLogged();
...
//     public void updateWithTime(double timestamp, Rotation2d gyroAngle, SwerveModulePosition[] modulePositions){
